function [root,fx,ea,iter,M] = falsePosition(func,xl,xu,es,maxiter)
% falsePosition function determines the approximate value of the root of a 
...
% In order to use the false position function the user must take care of
